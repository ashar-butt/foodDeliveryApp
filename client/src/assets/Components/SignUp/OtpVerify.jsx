...
const OtpVerify = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5001/Clientauth/signup-otp-verify', {
        email,
        otp,
      });
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const res = await axios.post('http://localhost:5001/Clientauth/resend-otp', { email });
      if (res.data.success) {
          ...
          <div className="card shadow-lg border-0" style={{ borderRadius: '20px', overflow: 'hidden' }}>
            ...
            <div className="card-body p-4" style={{ background: 'linear-gradient(145deg, #ffffff, #f8f9fa)' }}>
              <form onSubmit={handleSubmit}>
                ...
                >
                  <i className="bi bi-check-circle me-2"></i>Verify & Activate Account
                </button>
                ...
                >
                  <i className="bi bi-arrow-clockwise me-2"></i>Resend Verification Code
                </button>
              ...
              <div className="text-center mt-4 pt-3" style={{ borderTop: '1px solid #FFE0B2' }}>
                <p className="text-muted mb-2">Need to access your restaurant account?</p>
                  ...
                  <button 
                    ...
                    className="cool-btn cool-btn-primary cool-btn-sm"
                  >
                    <i className="bi bi-box-arrow-in-right me-2"></i>Login
                  </button>
                  <button 
                    onClick={() => navigate('/signup')} 
                    className="cool-btn cool-btn-success cool-btn-sm"
                  >

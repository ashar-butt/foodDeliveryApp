...
const ClientReviews = () => {
  ...
  const [stats, setStats] = useState({ total: 0, average: 0, breakdown: {} });
  ...
  const fetchReviews = async () => {
    try {
      ...
      const res = await axios.get(`http://localhost:5001/reviews/client/${client._id}`);
  ...
  if (loading) {
    return (
      <div className="container my-5 text-center">
        ...
        <p className="mt-3" style={{ color: '#FF5722' }}>Loading reviews...</p>
      </div>
    );
  }
    ...
    <div className="container mt-4">
      <div className="admin-card p-5 mb-4 position-relative overflow-hidden" style={{
        ...
        <div className="position-relative" style={{ zIndex: 2 }}>
          <div className="text-center mb-4">
            ...
            }}>See what customers think about your restaurant</p>
          </div>
      ...
      {reviews.length === 0 ? (
        <div className="admin-card p-5 text-center">
          ...
          <p className="text-muted">Your customers haven't left any reviews yet!</p>
        </div>
      ) : (

  ...
  const footerSections = [
    {
      ...
      icon: 'bi-utensils',
      links: [
        { path: '/restaurants', label: 'Restaurants', icon: 'bi-building' },
        { path: '/offers', label: 'Offers', icon: 'bi-percent' },
    ...
    },
    {
      ...
      icon: 'bi-person',
      links: [
        { path: '/recent-orders', label: 'My Orders', icon: 'bi-list-ul' },
        { path: '/profile', label: 'Profile', icon: 'bi-person-gear' },
        { path: '/my-reviews', label: 'Reviews', icon: 'bi-star' }
      ]
    }
  ];
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            ...
            <p className="mb-4" style={{ color: '#CCCCCC' }}>
              Fresh meals delivered to your door in minutes. Your hunger, our mission. Order from your favorite restaurants with ease.
            </p>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
              ...
              <div className="col-6">
                <div className="p-3 rounded-3" style={{ background: 'rgba(255, 87, 34, 0.1)' }}>
                  <div className="d-flex align-items-center justify-content-between">
                    <span className="small" style={{ color: '#CCCCCC' }}>Delivery</span>
                    <span className="badge bg-success rounded-pill">Fast</span>
                  </div>
                </div>
              </div>
              <div className="col-6">
                <div className="p-3 rounded-3" style={{ background: 'rgba(255, 152, 0, 0.1)' }}>
                  <div className="d-flex align-items-center justify-content-between">
                    <span className="small" style={{ color: '#CCCCCC' }}>Support</span>
                    <span className="badge bg-success rounded-pill">24/7</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="p-3 rounded-3 mb-3" style={{ background: 'rgba(255, 87, 34, 0.05)' }}>
              <div className="d-flex align-items-center justify-content-between mb-2">
                <span className="small" style={{ color: '#CCCCCC' }}>Order Now</span>
        ...
        <div className="row align-items-center">
          <div className="col-md-6 text-center text-md-start">
            ...
            <p className="mb-0 small" style={{ color: '#FF9800' }}>
              Made with <i className="bi bi-heart-fill mx-1" style={{ 
                color: '#FF5722',
                animation: 'pulse 2s infinite'
              }}></i> for food lovers everywhere
            </p>
          </div>

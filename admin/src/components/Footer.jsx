  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { path: '/clients', label: 'Clients', icon: 'bi-shop' },
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="d-flex align-items-center mb-3">
              <div className="me-3 d-flex align-items-center justify-content-center" style={{
                ...
                <i className="bi bi-gear-fill text-white" style={{ 
                  fontSize: '1.5rem',
            ...
            <p className="mb-4" style={{ color: '#CCCCCC' }}>
              Complete platform management solution. Monitor users, restaurants, orders, and customer feedback with real-time analytics.
            </p>
